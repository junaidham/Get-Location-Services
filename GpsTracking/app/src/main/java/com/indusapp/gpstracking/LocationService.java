...
public class LocationService extends Service implements
    ...
    protected void sendLocationDataToWebsite(Location location) {
        ...
        Log.e(TAG,"Called requestParams");
        ...
        Log.e(TAG,"--LoopjHttpClient");

        LoopjHttpClient.get(uploadWebsite, requestParams, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, cz.msebera.android.httpclient.Header[] headers, byte[] responseBody) {
                LoopjHttpClient.debugLoopJ(TAG, "sendLocationDataToWebsite - success",
                        uploadWebsite, requestParams, responseBody, headers, statusCode, null);
...
//                stopSelf();
    ...
    public void onLocationChanged(Location location) {
        if (location != null) {
            Log.e(TAG, "position: " + location.getLatitude() + ", "
...
//                stopLocationUpdates();
                ...
                Log.i(TAG,"Called sendLocationDataToWebsite ");
            }else{
                Log.i(TAG,"Called not sendLocationDataToWebsite ");
    ...
    public void onConnected(Bundle bundle) {
        ...
        locationRequest.setInterval(6*1000); // milliseconds
        ...
        try {
            ...
            Toast.makeText(this, "Go into settings and find Gps Tracker app and enable Location.", Toast.LENGTH_SHORT).show();
        }
    }
